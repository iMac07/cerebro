...
import org.xurpas.cerebro.interfaces.XApproval;
import org.xurpas.cerebro.interfaces.iCerebro;
import org.xurpas.cerebro.interfaces.iConnection;
import org.xurpas.cerebro.interfaces.iCrypt;

public class Synapse implements iCerebro{
    private final String SIGNATURE = "07071991";
    
    private iConnection poConn;
    private iCrypt poCrypt;
    ...
    public boolean loginUser(String fsProdctID) {
        System.out.println("Initializing user login.");
        pbLoaded = false;
    ...
    private String getSQ_User(){
        return "SELECT" +
                ...
                " FROM xxxSysUser a" +
                    " LEFT JOIN Client_Master b ON a.sClientiD = b.sClientID AND b.cEmployee = '1'";
