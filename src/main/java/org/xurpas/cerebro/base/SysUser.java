...
import org.xurpas.cerebro.constants.Logical;
import org.xurpas.cerebro.constants.TransactionStatus;
import org.xurpas.cerebro.interfaces.XRecordMas;
import org.xurpas.cerebro.interfaces.iCerebro;

public class SysUser{
    private final String MASTER_TABLE = "xxxSysUser";

    private final iCerebro p_oNautilus;
    private XRecordMas p_oListener;
    ...
    public SysUser(iCerebro foNautilus){
    ...
    public void setListener(Object foListener) {
        p_oListener = (XRecordMas) foListener;
    }
