...
import org.xurpas.cerebro.crypto.MySQLAES;
...
import org.xurpas.cerebro.interfaces.iProperty;
...
public class Property implements iProperty{
    ...
    public Property(String fsFile, String fsProdctID){
        ...
        try {
            if (!"".equals(System.getProperty("sys.default.path.config"))) {
                fsFile = System.getProperty("sys.default.path.config") + fsFile;
            }
    ...
    public void save(String fsFileName) {
        try {
            ...
            loProp.setProperty(psProductID + "-ServerName", getDBHost());
            loProp.setProperty(psProductID + "-MainServer", getMainServer());
            ...
            loProp.setProperty(psProductID + "-Port", getPort());
